...
// The Initial Developer of the Original Code is CDashSolutions.
// All Rights Reserved.
// 
    ...
    public partial class CommonHelper
    {
            ...
            else
            {
                    ...
                    && Convert.ToBoolean(ConfigurationManager.AppSettings["UseSSL"]))
                {
                    ...
                    if (!String.IsNullOrEmpty(sharedSslUrl))
                    {
                         ...
                         * but we cannot reference CDash.BusinessLogic.dll assembly.
            ...
            string valueName, bool defaultValue)
        {
            ...
            if (!bool.TryParse(str1, out result))
                throw new CDashException(string.Format("Value must be boolean {0}", valueName));
            return result;
        }
            ...
            string valueName, int defaultValue, bool zeroAllowed, int maxValueAllowed)
        {
            ...
            if (!int.TryParse(str1, out result))
            {
                if (zeroAllowed)
                {
                    throw new CDashException(string.Format("Value must be non negative integer {0}", valueName));
                }
                throw new CDashException(string.Format("Value must be positive integer {0}", valueName));
            }
            ...
            if ((maxValueAllowed > 0) && (result > maxValueAllowed))
                throw new CDashException(string.Format("Value too big {0}", valueName));
            return result;
        }
